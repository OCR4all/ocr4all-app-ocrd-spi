/**
 * File:     JsonTesserocrBinarize.java
...
/**
 * Defines service providers for ocr-d Tesserocr binarize with JSON support. The
 ...
 * @since 1.8
 */
public class JsonTesserocrBinarize extends OCRDDockerJsonServiceProviderWorker implements PreprocessingServiceProvider {
	/**
	...
	private enum ServiceProviderCollection implements ConfigurationServiceProvider.CollectionKey {
		processorIdentifier("tesserocr-binarize-json-id", "ocrd-tesserocr-binarize"),
		processorDescription("tesserocr-binarize-json-description", "ocr-d Tesserocr binarize processor");
	...
	/**
	 * Default constructor for a service provider for ocr-d Tesserocr binarize with
	 * JSON support.
	 * 
	 * @since 1.8
	 */
